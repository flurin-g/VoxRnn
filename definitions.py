...
def initialize() -> tuple:
    ...
    return npy_path, global_conf, train_conf, splits, meta, vox_dev_wav, vox_test_wav, weights


NPY_PATH, GLOBAL_CONF, TRAIN_CONF, SPLITS, META, VOX_DEV_WAV, VOX_TEST_WAV, WEIGHTS_PATH = initialize()
